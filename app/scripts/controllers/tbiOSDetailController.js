...
angular.module('sbAdminApp')
    .controller('tbiOSDetailCtrl',function($scope,$state,$stateParams,QualityService){

        
        var result = QualityService.get({platform:'tbios',method:'detail',version:$stateParams.versionId}, function(data){
