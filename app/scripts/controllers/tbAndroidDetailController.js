...
angular.module('sbAdminApp')
    .controller('tbAndroidDetailCtrl',function($scope,$state,$stateParams,QualityService){

        
        var result = QualityService.get({platform:'tbandroid',method:'detail',version:$stateParams.versionId}, function(data){
