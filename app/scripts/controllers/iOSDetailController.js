...
angular.module('sbAdminApp')
    .controller('iOSDetailCtrl',function($scope,$state,$stateParams,QualityService){

        
        var result = QualityService.get({platform:'shuqiios',method:'detail',version:$stateParams.versionId}, function(data){
