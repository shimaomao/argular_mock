...
/** @lends HarView */
{
    initialize: function(content)
    {
        ...
        var sJson;
        var o = Lib.getElementByClass(document, 'main');
        //var previewTab = this.getTab("Preview");
        var me = this;
        window.setHarData = function (oData) {
            me.showHar(oData);
        };
        this.getDataFromeTop(function (oData) {
            me.showHar(oData);
        });
    },
    showHar : function (oData) {
        this.appendPreview(oData.json);
    },
    getDataFromeTop : function (cb) {
        try{
            parent.getHarData(function (oData) {
                cb(oData);
            });
        }catch(e) {
